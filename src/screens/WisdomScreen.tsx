  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      role: 'assistant',
      text: 'Welcome, seeker. Ask what weighs on your spirit, and I will offer quiet counsel.',
    },
  ]);
      ...
      >
        ...
        >
          <View style={styles.hero}>
            <Text style={[styles.eyebrow, { color: theme.colors.secondary }]}>Wisdom App</Text>
            <Text style={[styles.title, { color: theme.colors.text }]}>One sanctuary for counsel and calm</Text>
            <Text style={[styles.subtitle, { color: theme.colors.secondary }]}
            >Speak your question, then breathe into stillness.</Text>
          </View>

          <View style={[styles.card, { backgroundColor: theme.colors.surface }]}
          >
            <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>AI Wisdom Counsel</Text>
            <Text style={[styles.sectionSubtitle, { color: theme.colors.secondary }]}>Ask spiritual or philosophical questions.</Text>
              ...
              {messages.map((msg) => (
                <View
                  ...
                  style={[
                    ...
                    {
                      backgroundColor: msg.role === 'assistant' ? theme.colors.accent : theme.colors.primary,
                    },
                  ]}
                >
                  <Text
                    style={[
                      styles.bubbleText,
                      { color: msg.role === 'assistant' ? theme.colors.text : '#fff' },
                    ]}
                  >
                    {msg.text}
                  </Text>
          ...
          <View style={[styles.card, { backgroundColor: theme.colors.surface }]}
          >
            <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Meditation Timer</Text>
            <Text style={[styles.sectionSubtitle, { color: theme.colors.secondary }]}
            >Align your breath with gentle bells and sound.</Text>
            ...
            {sessionComplete && (
              <View style={styles.completeBox}>
                ...
                <Text style={[styles.subtle, { color: theme.colors.secondary }]}
                >Duration: {durationMin} minutes</Text>
            ...
            <View style={styles.section}>
              ...
              {([
                ...
                <View key={key} style={styles.sliderRow}>
                  <Text style={[styles.sliderLabel, { color: theme.colors.secondary }]}
                  >{label}</Text>
                  <Slider
                    value={volumes[key]}
                    minimumValue={0}
...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontSize: 12, textTransform: 'uppercase', letterSpacing: 2 },
  ...
  sectionSubtitle: { fontSize: 14, marginBottom: 14 },
  ...
  timer: { fontSize: 48, fontWeight: '300', marginTop: 16, textAlign: 'center' },
